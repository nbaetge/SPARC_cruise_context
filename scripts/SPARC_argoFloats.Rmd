...
repo_root <- Sys.getenv(
  "SPARC_CONTEXT_PATH",
  "/Users/nicholasbaetge/github/cruise_context/SPARC_2025/SPARC_cruise_context_git"
)

# Make sure the directory exists
stopifnot(dir.exists(repo_root))

# Tell knitr where "project root" is and where to put chunk images
if (requireNamespace("knitr", quietly = TRUE)) {
  # send all *chunk-rendered* images to a subfolder under the REAL figs/
  knitr_img_dir <- file.path(repo_root, "figs", "knitr_")
  dir.create(knitr_img_dir, recursive = TRUE, showWarnings = FALSE)
  # knitr needs a trailing slash; paste0 is an easy way to enforce it
  knitr::opts_chunk$set(
    fig.path = paste0(knitr_img_dir, "/"),
    dev = "png",
    dpi = 150,
    cache = FALSE
  )
  # Also set the knit root so relative reads/writes behave from repo_root
...
## User settings ---------------------------------------------------------------
destdir <- file.path(repo_root, "data", "argo_data")
